...
### Remove Potions and Prevent Effect Application

Removes any potion (Splash, Lingering, or Drinkable) containing the `minecraft:night_vision` effect and prevents entities from receiving the effect.

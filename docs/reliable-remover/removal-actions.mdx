...
* **Use Case**: You want an item or status effect to exist and be usable in-game (via commands, mob abilities, potions, etc.), but not visible to players in creative tabs or recipe/effect browser menus.

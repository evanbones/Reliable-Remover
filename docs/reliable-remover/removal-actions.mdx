...
* **Use Case**: Useful if you want an item to exist for crafting but not be usable (e.g., banning a specific wand, tool, or bucket), or to disable right-click interactions on in-world blocks (e.g., anvils, beds, crafting tables, chests, levers).

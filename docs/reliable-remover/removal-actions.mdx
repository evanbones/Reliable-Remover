...
Hides any recipe from the Recipe Manager that results in the specified item.

* **Use Case**: Disable crafting or processing recipes for an item without removing the item itself from the game.

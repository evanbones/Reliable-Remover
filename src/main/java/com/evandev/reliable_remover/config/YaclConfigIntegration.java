...
public class YaclConfigIntegration {
    ...
    public static Screen createScreen(Screen parent) {
        ...
        *///?}
        ...
        rrvCategory.option(createBoolOption("enable_emi_removal", false, () -> config.enableEmiRemoval, val -> config.enableEmiRemoval = val));
        rrvCategory.option(createBoolOption("show_toast", true, () -> config.showEmiToast, val -> config.showEmiToast = val));
        rrvCategory.option(createBoolOption("show_chat_messages", true, () -> config.showEmiChatMessages, val -> config.showEmiChatMessages = val));
        rrvCategory.option(createBoolOption("reload_emi", false, () -> config.reloadAfterRemoval, val -> config.reloadAfterRemoval = val));
        *///?}
